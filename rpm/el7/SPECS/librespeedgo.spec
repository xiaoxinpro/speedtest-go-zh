...
License:	LGPL
URL:		https://github.com/xiaoxinpro/speedtest-go-zh
Source0:	%{name}.tar.gz
...
%prep
curl -sL 'https://github.com/xiaoxinpro/speedtest-go-zh/archive/refs/tags/v%{version}.tar.gz' -o %{_sourcedir}/%{name}.tar.gz
